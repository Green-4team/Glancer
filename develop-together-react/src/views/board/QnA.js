        ...
        <CCardBody>
          <div style={{display: 'flex'}}>
            ...
            <div style={{textAlign: 'center', display: 'inline-block', width: '70%', margin: 'auto'}}>
              <CButton style={{color: 'black', backgroundColor: 'white', border: 0, marginRight: 20}}>기술</CButton>
              <CButton style={{color: 'black', backgroundColor: 'white', border: 0, marginRight: 20}}>커리어</CButton>
              <CButton style={{color: 'black', backgroundColor: 'white', border: 0, marginRight: 20}}>기타</CButton>
              <CButton style={{color: 'black', backgroundColor: 'white', border: 0}}>전체</CButton>
            </div>
