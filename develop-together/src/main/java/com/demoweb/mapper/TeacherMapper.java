...
public interface TeacherMapper {
	...
	@Select("SELECT t.teacherno, t.memberid, t.education, t.career, t.scontent, t.content, t.rate, t.region, m.name, m.email, m.phone, m.occupation " +
	...
	@Insert("INSERT INTO teacher (memberid, region, education, career, scontent, content) " +
			"VALUES (#{memberid}, #{region}, #{education}, #{career}, #{scontent}, #{content} ) ")
	@Options(useGeneratedKeys = true, keyColumn = "teacherno", keyProperty = "teacherno")
	void registerTeacher(TeacherDto register);

	
	@Update("UPDATE teacher " +
			"SET region = #{region}, education = #{education}, career = #{career}, scontent = #{scontent}, content = #{content} " +
